...
namespace Fuzzy {
    class EntityCar {
        public:
            EntityCar(SDL::Vector2i position, SDL::Vector2i direction = SDL::Vector2i(0, 0));
            EntityCar(SDL::Window &window, SDL::Vector2i position, SDL::Vector2i direction = SDL::Vector2i(0, 0));
            ~EntityCar() = default;
